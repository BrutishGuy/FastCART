...
std::tuple<std::string, double, double, double, ClassCounter, ClassCounter> determine_best_threshold_numeric(const Data &data, int col);

std::tuple<std::string, double, double, double, ClassCounter, ClassCounter> determine_best_threshold_cat(const Data &data, int col);
